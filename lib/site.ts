...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: "concrete",
    image: "/images/proof/commercial-walk-night-01.jpg",
    alt: "Commercial walkway concrete cleaned at night in Metro Detroit",
    bodyImages: [
...
export const proof: ProofShot[] = [
  ...
  { image: "/images/proof/gutter-guard-clean-01.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Clean gutter guards after gutter cleaning in Metro Detroit" },
  { image: "/images/proof/gutter-guard-clean-02.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Cleared gutter guards on a shingle roof in Macomb, MI" },
  { image: "/images/proof/gutter-guard-street-01.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Cleaned gutters along the roofline in Metro Detroit" },
  { image: "/images/proof/gutter-blower-action-01.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Gutters being cleared and blown out in Macomb, MI" },
  { image: "/images/proof/gutter-guard-valley-01.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Cleaned gutters and roof valley in Metro Detroit" },
  { image: "/images/proof/gutter-guard-backyard-01.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Cleared gutters above the backyard in Macomb, MI" },
  { image: "/images/proof/gutter-clean-siding-01.jpg", tag: "Gutters", service: "gutter-cleaning", alt: "Cleaned gutters and downspout along the siding in Metro Detroit" },
  { image: "/images/proof/window-commercial-interior-atrium-01.jpg", tag: "Windows", service: "window-cleaning", alt: "Interior atrium windows cleaned clear on a commercial building in Metro Detroit" },
  { image: "/images/proof/window-commercial-curtainwall-01.jpg", tag: "Windows", service: "window-cleaning", alt: "Commercial glass curtain wall cleaned in Macomb County" },
  { image: "/images/proof/window-commercial-curtainwall-02.jpg", tag: "Windows", service: "window-cleaning", alt: "Two story commercial windows cleaned streak free in Metro Detroit" },
  { image: "/images/proof/window-commercial-column-01.jpg", tag: "Windows", service: "window-cleaning", alt: "Commercial storefront glass cleaned in Macomb, MI" },
  { image: "/images/proof/window-commercial-tower-01.jpg", tag: "Windows", service: "window-cleaning", alt: "Tall commercial window tower cleaned in Metro Detroit" },
  { image: "/images/proof/window-commercial-gym-01.jpg", tag: "Windows", service: "window-cleaning", alt: "Floor to ceiling gym windows cleaned clear in Macomb County" },
  { image: "/images/proof/window-commercial-gym-02.jpg", tag: "Windows", service: "window-cleaning", alt: "Commercial fitness room windows cleaned in Metro Detroit" },
  { image: "/images/proof/window-commercial-truck-01.jpg", tag: "Windows", service: "window-cleaning", alt: "Are You Washed on site for commercial window cleaning in Metro Detroit" },
  { image: "/images/proof/window-commercial-gym-03.jpg", tag: "Windows", service: "window-cleaning", alt: "Curved commercial window wall cleaned in Macomb, MI" },
  { image: "/images/proof/window-commercial-gym-04.jpg", tag: "Windows", service: "window-cleaning", alt: "Large gym windows cleaned with clear views in Metro Detroit" },
];
