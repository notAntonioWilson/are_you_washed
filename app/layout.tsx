...
export const metadata: Metadata = {
  ...
  description:
    "Family-owned pressure washing in Macomb, Washington Township & Metro Detroit. House washing, soft washing, roof washing, window cleaning, gutter cleaning, concrete, driveway, patio & deck cleaning, and rust removal. 5.0★ rated, licensed & insured. Free quotes, call 586-238-0784.",
  keywords: [
    "pressure washing Macomb MI",
    "power washing Metro Detroit",
    "house washing Macomb Township",
    "soft washing Michigan",
    "roof washing Macomb MI",
    "window cleaning Metro Detroit",
    "gutter cleaning Macomb MI",
    "concrete cleaning Metro Detroit",
    "driveway cleaning Macomb",
    "patio and deck cleaning Metro Detroit",
    "rust removal Macomb MI",
    "commercial pressure washing Metro Detroit",
    "commercial window cleaning Metro Detroit",
    "window cleaning Sterling Heights",
    "gutter cleaning Clinton Township",
    "roof washing Shelby Township",
    "house washing Troy MI",
    "pressure washing Washington Township",
    "licensed and insured pressure washing Macomb",
    "family owned pressure washing Metro Detroit",
